    ...
    return (
        <section className="flex flex-col md:flex-row lg:flex-row xl:flex-row 2xl:flex-row items-start bg-gradient-to-br from-[#a8c2b2] via-[#85a791] to-[#567d63] min-h-screen p-4 md:p-8 overflow-hidden relative">
            ...
            <div className="w-full md:w-2/5 lg:w-1/3 xl:w-1/3 2xl:w-1/3 text-left md:sticky top-0 z-10">
                <h1 className="text-2xl sm:text-5xl md:text-6xl lg:text-6xl xl:text-6xl 2xl:text-6xl font-bold text-[#333] mb-4 md:mb-6 pl-2 md:pl-4 mt-4 md:mt-6 tracking-tight animate-[fadeIn_1s_ease-in-out] md:[text-shadow:_2px_2px_4px_rgb(0_0_0_/_20%)] hover:scale-105 transition-transform">CAREERS</h1>
                <hr className="w-16 ml-3 md:w-32 border-3 border-[#f0a500] mb-6 md:mb-8 transition-all duration-500 ease-in-out hover:w-56 animate-[pulse_2s_infinite]" />
                <div 
                    className="perspective-[2000px] flex justify-center md:justify-start"
                ...
                >
                    <img
                        ...
                        className={`w-full max-w-[250px] sm:max-w-[500px] md:max-w-[700px] lg:max-w-[800px] xl:max-w-[1000px] 2xl:max-w-[1200px] h-auto object-contain mt-4 md:mt-6 mb-4 mx-auto md:ml-4 transition-all duration-300 rounded-lg filter ${isHovering ? 'brightness-125 contrast-125 saturate-150' : ''} animate-[float_6s_ease-in-out_infinite]`}
                        style={{
            ...
            <div className="w-full mt-8 sm:mt-16 md:mt-32 mx-2 sm:mx-4 md:mx-8 md:w-3/5 lg:w-2/3 xl:w-2/3 2xl:w-2/3 pl-0 md:pl-8 lg:pl-16 xl:pl-20 2xl:pl-24 rounded-2xl p-4 sm:p-6 md:p-8 md:backdrop-blur-sm md:bg-white/10 z-10 hover:md:bg-white/20 transition-all duration-300">
                ...
                <p className="sm:text-xl md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl text-[#333] leading-relaxed mb-4 sm:mb-6 md:mb-8 font-light hover:text-[#085846] transition-all duration-300 transform hover:scale-[1.01] [text-shadow:_1px_1px_2px_rgb(0_0_0_/_15%)] hover:translate-x-2">
                ...
                <p className=" sm:text-xl md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl text-[#333] leading-relaxed mb-6 sm:mb-8 md:mb-10 font-light hover:text-[#085846] transition-all duration-300 transform hover:scale-[1.01] [text-shadow:_1px_1px_2px_rgb(0_0_0_/_15%)] hover:translate-x-2">
                ...
                <Link
                    to="/careers"
                    className="inline-block py-2 px-6 sm:py-4 sm:px-10 md:py-4 md:px-10 lg:py-5 lg:px-12 xl:py-6 xl:px-14 2xl:py-7 2xl:px-16 mt-4 md:mt-6 bg-[#085846] text-white rounded-full text-sm sm:text-lg md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl transition-all duration-500 ease-in-out transform hover:bg-[#021f18] hover:translate-y-[-8px] hover:scale-110 hover:rotate-2 active:translate-y-[2px] mb-4 sm:mb-8 md:mb-10 border-2 border-transparent hover:border-[#f0a500] hover:shadow-[0_0_35px_rgba(240,165,0,0.8)] relative overflow-hidden group animate-[pulse_3s_infinite]"
                >
