            ...
            <div className="w-full md:w-1/2">
                ...
                <div className="relative text-center w-full">
                    ...
                    <div className="pt-0 -mt-24 pl-9 pr-9 absolute inset-0 flex flex-col justify-center text-black bg-opacity-50 text-left rounded-lg md:pl-8 md:pt--1">
                        <h3 className="text-[12px] md:text-[10px] lg:text-[20px] lg:pl-9 lg:pr-9  font-bold">Factors that may affect pricing include:</h3>
                        <ul className="text-[12px] md:text-[10px] lg:text-[20px] mt-2 text-left lg:pl-9 lg:pr-9 ">
