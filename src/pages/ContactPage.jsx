...
//               </a>
//               <a href="mailto:Support@cozycare.world" className='bg-[rgb(3,43,3)] text-white py-3 px-6 rounded-lg hover:bg-[#98FB98] hover:text-[rgb(3,43,3)] transition-all duration-300 transform hover:scale-110 text-center hover:shadow-xl flex items-center justify-center gap-2'>
//                 <span>Support@cozycare.world</span>
    ...
    <div className="min-h-screen items-center justify-center bg-gradient-to-b from-[#FDF5E6] to-[#e6dbc7] pt-11 w-full h-full">
      <div className="w-full max-w-7xl px-1 animate-fadeIn mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-20 text-white backdrop-blur-sm bg-opacity-20 p-8 rounded-2xl shadow-2xl">
          ...
          <div className="border-2 border-[#98FB98] p-4 rounded-lg bg-[#032b03]">
            <div className="flex justify-between items-center mb-6 gap-2">
              <label htmlFor="recaptcha-checkbox" className="flex items-center gap-2 cursor-pointer text-white">
                <input
                  type="checkbox"
              ...
              <div className="h-6 w-6 bg-transparent border-2 border-gray-300 rounded-md flex justify-center items-center">
                <img src="https://www.google.com/recaptcha/api2/logo/recaptcha_logo.svg" alt="reCAPTCHA" className="h-4 w-4" />
              </div>
            </div>
          </div>
